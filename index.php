    ...
    <div class="container clearfix">
        <div class="row clearfix">
            ...
            <div class="three-column clearfix">
                ...
                <?php get_template_part('part/news-part') ?>
                <?php endwhile; ?>
            </div>
            <?php wp_reset_postdata(); ?>
            <?php 
...
<div class="section highlight bg-dark-blue">
    <div class="container clearfix">
        <div class="row tcenter">
            <a href="https://forms.gle/4t1YkAt62kb6qiTG8" class="action_btn down_animation">Apply to be a GCR Contributor</a> 
        </div>
    </div>
</div>
